...
public class ScistorClient {

	private static final Log LOG = LogFactory.getLog(ScistorClient.class);
	...
	public static void main(String[] args) {
		...
		try {
			ScistorClient client = new ScistorClient();
	...
	public ScistorClient(Configuration conf) throws Exception {
		this(
				"com.scistor.dshell.ScistorApplicationMaster",
				conf);
	}
	...
	ScistorClient(String appMasterMainClass, Configuration conf) {
		...
		// ↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓
		opts.addOption("container_jars", true,
				"The jars that containers will run .Separated by comma");
		// ↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑
		opts.addOption(
				"shell_command",
				true,
		...
		if (cliParser.hasOption("log_properties")) {
			...
			try {
				Log4jPropertyHelper.updateLog4jConfiguration(
						ScistorClient.class, log4jPath);
			} catch (Exception e) {
				LOG.warn("Can not set up custom log4j properties. " + e);
			}
		}
		// 得到命令行中的container_jars选项，并赋值给本地变量↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓
		if (cliParser.hasOption("container_jars")) {
			containerJarPaths = cliParser.getOptionValue("container_jars")
					.split(",");
		}
		// ↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑
	...
	public boolean run() throws IOException, YarnException {
		...
		// scripts
		env.put(ScistorDSConstants.DISTRIBUTEDSHELLSCRIPTLOCATION,
				hdfsShellScriptLocation);
		env.put(ScistorDSConstants.DISTRIBUTEDSHELLSCRIPTTIMESTAMP,
				Long.toString(hdfsShellScriptTimestamp));
		env.put(ScistorDSConstants.DISTRIBUTEDSHELLSCRIPTLEN,
		...
		if (containerJarPaths.length != 0) {
			for (int i = 0; i < containerJarPaths.length; i++) {
				...
				if (!containerJarPaths[i].isEmpty()) {
					...
					env.put(ScistorDSConstants.DISTRIBUTEDJARLOCATION + i,
							hdfsJarLocation);
					env.put(ScistorDSConstants.DISTRIBUTEDJARTIMESTAMP + i,
							Long.toString(hdfsJarTimestamp));
					env.put(ScistorDSConstants.DISTRIBUTEDJARLEN + i,
